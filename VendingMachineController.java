    ...
    private void initiateTest() {
        if (rVendingMachine != null) {
            if (testRegularMachineView == null) {
                testRegularMachineView = new TestRegularMachineView();
            ...
            // Handle testing for special machine
        } else {
    ...
    private void performMaintenance() {
        if (rVendingMachine != null) {
            if (maintenanceView == null) {
                ...
                maintenanceController = new MaintenanceController(maintenanceView, rVendingMachine);
            }
